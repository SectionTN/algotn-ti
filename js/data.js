...
window.ALGOTN_CHAPTERS = [
  { id:"bases", num:"01", slug:"chapters/bases.html", title:"Algorithmes de base", icon:"▶",
    ...
    tags:["Variables","E/S","Affectation"], grad:"linear-gradient(135deg,#6366f1,#8b5cf6)", built:true },
  { id:"conditions", num:"02", slug:"chapters/conditions.html", title:"Les conditions", icon:"⑂",
    ...
    tags:["SI","SELON","Booléens"], grad:"linear-gradient(135deg,#3b82f6,#06b6d4)", built:true },
  { id:"boucles", num:"03", slug:"chapters/boucles.html", title:"Les boucles", icon:"↻",
    ...
    tags:["POUR","TANT QUE","RÉPÉTER"], grad:"linear-gradient(135deg,#06b6d4,#10b981)", built:true },
  { id:"tableaux", num:"04", slug:"chapters/tableaux.html", title:"Les tableaux", icon:"▦",
    ...
    tags:["1D","2D","Parcours"], grad:"linear-gradient(135deg,#10b981,#84cc16)", built:true },
  { id:"procedures", num:"05", slug:"chapters/procedures-fonctions.html", title:"Procédures & Fonctions", icon:"ƒ",
    ...
    tags:["Paramètres","Retour","Pile"], grad:"linear-gradient(135deg,#f59e0b,#ef4444)", built:true, important:true },
  ...
  { id:"enregistrements", num:"07", slug:"chapters/enregistrements.html", title:"Les enregistrements", icon:"▤",
    ...
    tags:["Structure","Champs","Type"], grad:"linear-gradient(135deg,#ec4899,#f43f5e)", built:true },
  ...
  { id:"structures-dyn", num:"10", slug:"chapters/structures-dynamiques.html", title:"Structures dynamiques", icon:"❖",
    ...
    tags:["Dynamique","Tas","Allocation"], grad:"linear-gradient(135deg,#6366f1,#0ea5e9)", built:true },
  { id:"piles", num:"11", slug:"chapters/piles.html", title:"Les piles", icon:"▣",
    ...
    tags:["LIFO","Push","Pop"], grad:"linear-gradient(135deg,#14b8a6,#06b6d4)", built:true },
  { id:"files", num:"12", slug:"chapters/files.html", title:"Les files", icon:"▤",
    ...
    tags:["FIFO","Enfiler","Défiler"], grad:"linear-gradient(135deg,#06b6d4,#3b82f6)", built:true },
  { id:"recherche", num:"13", slug:"chapters/recherche.html", title:"La recherche", icon:"⌕",
    ...
    tags:["Séquentielle","Dichotomique"], grad:"linear-gradient(135deg,#a855f7,#6366f1)", built:true },
  { id:"tri", num:"14", slug:"chapters/tri.html", title:"Les tris", icon:"⇅",
    ...
    tags:["Bulle","Sélection","Insertion"], grad:"linear-gradient(135deg,#f43f5e,#ec4899)", built:true },
  { id:"complexite", num:"15", slug:"chapters/complexite.html", title:"La complexité", icon:"𝒪",
    ...
    tags:["Big-O","Performance"], grad:"linear-gradient(135deg,#64748b,#334155)", built:true },
];
